...
let scoreNumber = localStorage.getItem('scoreForTimed1'); // Variable to store score of timed mode
...
function insertNumInMainDiv(number, idForNumInBottom) {
    var numberButtonInMainDiv = document.createElement("button");
	numberButtonInMainDiv.setAttribute("class", "classForNumButtonInMainDiv");
...
var signButtonInMainDiv = document.createElement("button");
signButtonInMainDiv.setAttribute("class", "classForSignButtonInMainDiv");
...
function removeButton(idName, idForNumInBottom) {
	...
	idForNumInBottom.style.display = "block";
...
function finalAnsCalc(value, condition) {
    ...
    if(result==operation3){
        ...
        let  scoreNumber1 = localStorage.getItem('scoreForTimed1');
        scoreNumber1++;
        localStorage.setItem('scoreForTimed1', scoreNumber1 );
...
// This function is used for Timer function in Timed mode
...
function countdown() {
	...
	if(localStorage.getItem("theme")=="theme2"){
		counter.style.color = "#BCB7A5";
	}
	else if(localStorage.getItem("theme")=="theme1"){

		counter.style.color = "#E8567C";
	}
	else if(localStorage.getItem("theme")=="theme3"){
		counter.style.color = "#AAAAAA";
	}
	else if(localStorage.getItem("theme")=="theme4"){
		counter.style.color = "#DCD5BF";
	}
	else if(localStorage.getItem("theme")=="theme5"){
		counter.style.color = "#DFD1DB";
	}
      seconds--;
      counter.innerHTML =
      ...
      if (seconds > 0) {
		...
		if(result!=operation3)document.getElementById("counter").innerHTML = "YOU LOSE";
        if(localStorage.getItem("sound")=="true"){
			loseSound.play();
		}
		randomNum1.removeAttribute("onclick");
		randomNum2.removeAttribute("onclick");
		randomNum3.removeAttribute("onclick");
		randomNum4.removeAttribute("onclick");
		document.getElementById("mainDiv").innerHTML="";
		document.getElementById("answerDiv").innerText="";
        seconds=60;
      }
    }
	tick();
